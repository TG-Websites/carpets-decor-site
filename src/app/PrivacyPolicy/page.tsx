...
>
      ...
      <section className="py-16 px-4 max-w-5xl mx-auto text-gray-300 space-y-14">
        ...
        <div>
          ...
          <p className="text-gray-400 leading-relaxed">
            Hands Carpets is committed to ensuring your privacy is protected. This privacy policy outlines how your
  ...
  <ul className="list-disc list-inside pl-4 space-y-4 text-gray-300">
    ...
    <li>
      ...
      Hands Carpets team members or authorized staff may access your information strictly for fulfilling orders, customer service, and enhancing user experience. Access is limited and monitored.
    </li>
  </ul>
</div>
...
<div className="space-y-4">
  ...
  <p className="text-white">
    At Hands Carpets, the security of your personal information is of utmost importance to us. We follow
...
<div className="mt-12 space-y-4">
  ...
  <ul className="mt-3 space-y-2 text-gray-300 text-base">
    ...
    <li>
      <span className="font-semibold text-[#f4d57f]">Phone:</span> +91 1234567890
    </li>
    <li>
      <span className="font-semibold text-[#f4d57f]">Address:</span> 123 Carpet Street, New Delhi, India
    </li>
  </ul>
</div>
